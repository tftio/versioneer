...
# Automated release script for versioneer
...
log_success "Created tag: versioneer-v$NEW_VERSION"

# Final confirmation
echo
log_info "Ready to push release:"
log_info "  Version: $NEW_VERSION"
log_info "  Tag: versioneer-v$NEW_VERSION"
...
log_info "Monitor the release at: https://github.com/workhelix/versioneer/actions"
log_info "Release will be available at: https://github.com/workhelix/versioneer/releases/tag/versioneer-v$NEW_VERSION"